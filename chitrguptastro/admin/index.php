  ...
  <div class="row g-4">
    <div class="col-md-6 col-lg-3">
      <div class="card border-0 shadow-sm p-4 h-100">
        <h5 class="text-primary mb-3"><i class="bi bi-briefcase me-2"></i>Total Services</h5>
        <h2 class="display-6 fw-bold mb-0"><?php echo $totalservice; ?></h2>
        <small class="text-muted mt-2">Services managed</small>
      </div>
    </div>

    <div class="col-md-6 col-lg-3">
      <div class="card border-0 shadow-sm p-4 h-100">
        <h5 class="text-success mb-3"><i class="bi bi-check-circle me-2"></i>Active Services</h5>
        <h2 class="display-6 fw-bold mb-0"><?php echo $activeservice; ?></h2>
        <small class="text-muted mt-2">Currently active</small>
      </div>
    </div>

    <div class="col-md-6 col-lg-3">
      <div class="card border-0 shadow-sm p-4 h-100">
        <h5 class="text-danger mb-3"><i class="bi bi-x-circle me-2"></i>Inactive Services</h5>
        <h2 class="display-6 fw-bold mb-0"><?php echo $inactiveservice; ?></h2>
        <small class="text-muted mt-2">Not active</small>
      </div>
    </div>

    <div class="col-md-6 col-lg-3">
      <div class="card border-0 shadow-sm p-4 h-100">
        <h5 class="text-info mb-3"><i class="bi bi-chat-dots me-2"></i>Total Enquiries</h5>
        <h2 class="display-6 fw-bold mb-0"><?php echo $totalLeads === null ? 'N/A' : $totalLeads; ?></h2>
        <small class="text-muted mt-2">Customer inquiries</small>
      </div>
    </div>
  </div>
