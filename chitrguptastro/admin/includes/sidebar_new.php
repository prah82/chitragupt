...
<aside class="sidebar bg-dark">
  ...
  <div class="sidebar-footer">
    <button class="btn btn-outline-light btn-sm w-100" onclick="alert('Logout functionality here')">
...
<header class="topbar">
  ...
  <div class="topbar-right">
    <div class="user-profile">
      ...
      <span class="user-name"><?php echo htmlspecialchars(ucwords(strtolower($_SESSION['admin_username'] ?? 'Admin'))); ?></span>
    </div>
  </div>
</header>
