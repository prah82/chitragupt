...
<style>
 ...
 <div id="serviceMsg" class="service-toast" style="display:none;" role="alert"></div>
  ...
  <form id="serviceForm" enctype="multipart/form-data">
    ...
    <div class="row g-3 mb-3">
      <div class="col-md-6">
        ...
        <div class="form-text">Max size: 1MB. Allowed formats: JPG, JPEG, PNG, WEBP. New course ke liye image required hai.</div>
      </div>
      <div class="col-md-6">
...
(function() {
  ...
  // Image ratio restriction removed. Only backend file type and size validation will run.
...
function showMsg(text, ok) {
  ...
  msgBox.innerHTML = escapeHtml(text) + '<button type="button" class="btn-close" aria-label="Close"></button>';

  var closeBtn = msgBox.querySelector('.btn-close');
  if (closeBtn) {
