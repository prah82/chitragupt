...
$whatWeOfferservice = [];
$specializedservice = [];
$frontendDbPath = __DIR__ . '/admin/includes/db.php';
...
<section class="hero">
  ...
  </div><div class="footer-bottom"><p>© 2017-2026 Shree Chitragupt Institute Of Astro Studies and Research</p><p>Developed by <a class="footer-dev-link" href="https://euonusit.com/" target="_blank" rel="noopener noreferrer">EUONUS IT</a></p></div></div></footer>
</div>
...
<?php endif; ?>
          ...
          <article class="gallery-video-card fi">
            <div class="gallery-video-thumb home-intro-youtube" onclick="playGalleryVideo(this)" role="button" tabindex="0" aria-label="Play Geopathic Stress video" data-video-id="h1hT3Q7RDPY">
              <img src="https://img.youtube.com/vi/h1hT3Q7RDPY/maxresdefault.jpg" alt="Geopathic Stress video thumbnail">
              <span class="video-play">▶</span>
            </div>
            <div class="gallery-video-body">
              <h3>Understanding Geopathic Stress</h3>
              <p>Scientific explanation of geopathic stress and its impact on human health and well-being.</p>
              <div class="gallery-video-actions">
                <a class="btn btn-dark btn-sm" href="https://youtu.be/h1hT3Q7RDPY" target="_blank" rel="noopener noreferrer">Open Video</a>
              </div>
            </div>
          </article>
  ...
  <!-- <section class="section" style="background:var(--white)">
    <div class="container">
      <div class="sec-header fi"><span class="label">Events & Training</span><h2>Workshops, Conferences & Community Programs</h2><p>Empowering people is at the heart of what we do â€” here's what it looks like in practice.</p></div>
      <div class="gal-grid">
        <div class="gal-item fi" style="background:linear-gradient(135deg,#8B662D,#0a1628)" onclick="openLightbox('ðŸŽ“','Environmental Law Workshop â€” Delhi, 2023','linear-gradient(135deg,#8B662D,#0a1628)')">ðŸŽ“<div class="gal-overlay">Environmental Law Workshop â€” Delhi, 2023</div></div>
        <div class="gal-item fi" style="background:linear-gradient(135deg,#C49A3C,#162d55)" onclick="openLightbox('ðŸŽ¤','National Astro Conference, 2022','linear-gradient(135deg,#C49A3C,#162d55)')">ðŸŽ¤<div class="gal-overlay">National Astro Conference, 2022</div></div>
        <div class="gal-item fi" style="background:linear-gradient(135deg,#E8D5B7,#0a1628)" onclick="openLightbox('ðŸ‘¥','Village Capacity Building â€” 200 Participants','linear-gradient(135deg,#E8D5B7,#0a1628)')">ðŸ‘¥<div class="gal-overlay">Village Capacity Building â€” 200 Participants</div></div>
        <div class="gal-item fi" style="background:linear-gradient(135deg,#A67C35,#0f2040)" onclick="openLightbox('ðŸ“Š','Research Symposium â€” Jaipur, 2023','linear-gradient(135deg,#A67C35,#0f2040)')">ðŸ“Š<div class="gal-overlay">Research Symposium â€” Jaipur, 2023</div></div>
        <div class="gal-item fi" style="background:linear-gradient(135deg,#C49A3C,#1e3a6e)" onclick="openLightbox('ðŸ§ª','Soil Health Training â€” Farmers Field School','linear-gradient(135deg,#C49A3C,#1e3a6e)')">ðŸ§ª<div class="gal-overlay">Soil Health Training â€” Farmers Field School</div></div>
        <div class="gal-item fi" style="background:linear-gradient(135deg,#8B662D,#162d55)" onclick="openLightbox('ðŸ¤','Government Partnership Launch â€” 2021','linear-gradient(135deg,#8B662D,#162d55)')">ðŸ¤<div class="gal-overlay">Government Partnership Launch â€” 2021</div></div>
      </div>
    </div>
  </section> -->
...
<div class="page" id="page-books">
  ...
  <section class="section" style="background:var(--s1)">
    <div class="container">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:1.5rem">
        <div class="srv-card fi" style="text-align:center"><div class="srv-icon" style="margin:0 auto 1rem">âœï¸</div><h4 style="color:var(--n9);margin-bottom:.75rem">Expert Research</h4><p style="font-size:.875rem">Authored by Dr. Rajesh Srivastav, a doctorate in Vastu Shastra with over 25 years of research experience.</p></div>
        <div class="srv-card fi" style="text-align:center"><div class="srv-icon" style="margin:0 auto 1rem">ðŸ”¬</div><h4 style="color:var(--n9);margin-bottom:.75rem">Scientific Approach</h4><p style="font-size:.875rem">A blend of traditional knowledge and modern scientific analysis for practical, measurable results.</p></div>
        <div class="srv-card fi" style="text-align:center"><div class="srv-icon" style="margin:0 auto 1rem">ðŸ“š</div><h4 style="color:var(--n9);margin-bottom:.75rem">Practical Guidance</h4><p style="font-size:.875rem">Real-world case studies, step-by-step remedies, and actionable solutions you can implement immediately.</p></div>
        <div class="srv-card fi" style="text-align:center"><div class="srv-icon" style="margin:0 auto 1rem">ðŸ’¡</div><h4 style="color:var(--n9);margin-bottom:.75rem">Easy to Understand</h4><p style="font-size:.875rem">Complex concepts explained in simple language, with illustrations, charts, and practical examples.</p></div>
      </div>
    </div>
  </section>
...
<script>
  ...
  /* â”€â”€ Load page from URL hash â”€â”€ */
